...
function Videocard({ displayVideo, setDeleteVideoStatus }) {
    ...
    const handleShow = async() =>{
        ...
        // 3 datas needed 1. caption,2. link, 3. timestamp
    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Body>
                <iframe width="100%" height="480" src={`${displayVideo.embededLink}?autoplay=1$mute=1`} allow=" autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                </Modal.Body>
                <Modal.Footer>
